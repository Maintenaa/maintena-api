...
export const createPositionRequestSchema = t.Object({
  ...
  isAdmin: t.Optional(t.MaybeEmpty(t.Boolean({ default: false }))),
  isTechnician: t.Optional(t.MaybeEmpty(t.Boolean({ default: false }))),
  isOwner: t.Optional(t.MaybeEmpty(t.Boolean({ default: false }))),
});
